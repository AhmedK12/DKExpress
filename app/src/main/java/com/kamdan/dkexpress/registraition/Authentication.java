        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    User user1 = new User();
                    user1.setName(data[0]);
                    user1.setShop(data[1]);
                    user1.setNumber(data[2]);
                    user1.setLocation(data[3]);
                    user1.setId(user.getUid());
                    user1.setDue("0");
                    user1.setCredit("100");
                    user1.setEmail(user.getEmail());
                    rootRef.child(user.getUid()).setValue(user1);
                    Intent i = new Intent(Authentication.this, ProductActivity.class).putExtra("brand","");
                    startActivity(i);
