...
import com.kamdan.dkexpress.R;
import com.kamdan.dkexpress.grocery.Cart_adapter;
import com.kamdan.dkexpress.grocery.Database;
import com.kamdan.dkexpress.grocery.OederPlaced;
...
public class Cart extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void SetCart_Item(){
        LinearLayoutManager layoutManager = new LinearLayoutManager(com.kamdan.dkexpress.cakes.Cart.this);
